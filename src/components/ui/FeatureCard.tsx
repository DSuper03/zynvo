  ...
  const renderCard = () => {
    switch (feature.variant) {
      case 'primary':
        return (
          <div
            className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${feature.accentColor} ${feature.height} flex flex-col`}
          >
      ...
      case 'secondary':
        return (
          <div
            className={`relative overflow-hidden rounded-2xl ${feature.height} border border-yellow-500/30 bg-black/50 backdrop-blur-sm`}
          >
      ...
      case 'tertiary':
        return (
          <div
            className={`relative overflow-hidden rounded-2xl ${feature.height} bg-gradient-to-br ${feature.accentColor}`}
          >
      ...
      case 'highlight':
        return (
          <div
            className={`relative overflow-hidden rounded-2xl ${feature.height} border-2 border-dashed border-rose-500/50 bg-gray-900`}
          >
      ...
      case 'bordered':
        return (
          <div
            className={`relative overflow-hidden rounded-2xl ${feature.height} bg-gray-900/70 backdrop-blur-sm border border-cyan-500/30`}
          >
      ...
      default:
        return (
          <div
            className={`relative overflow-hidden rounded-2xl bg-gray-800 ${feature.height}`}
          >
            <div className="p-6">

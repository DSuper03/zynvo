...
export const MOCK_NEWS_DATA: NewsArticle[] = [
  {
    ...
    description: 'IIT Bombay inaugurates a state-of-the-art Artificial Intelligence research center, aiming to foster innovation and collaboration among students and faculty.',
    imageUrl: 'https://images.unsplash.com/photo-1503676382389-4809596d5290?w=800&h=450&fit=crop&auto=format',
  ...
  },
  {
    ...
    description: 'A team from Delhi University clinched the top spot at the National Debate Championship, showcasing exceptional talent and critical thinking.',
  ...
  },
  {
    ...
    description: 'IIM Ahmedabad’s annual business summit attracts top industry leaders and students for discussions on entrepreneurship and innovation.',
  ...
  },
  {
    ...
    description: 'Engineering students at NIT Trichy unveil a solar-powered vehicle prototype, aiming to promote sustainable transportation on campus.',
  ...
  },
  {
    ...
    description: 'Shri Ram College of Commerce (SRCC), Delhi, hosts an inter-college sports meet with participation from over 30 colleges across India.',
    imageUrl: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=450&fit=crop&auto=format',
  ...
  },
  {
    ...
    description: 'The annual student film festival features innovative short films and documentaries, highlighting the creative talents of students from various disciplines.',
  ...
  },
  {
    ...
    description: 'Experts and industry leaders gather at the Tech Symposium to discuss the future of AI, its ethical implications, and potential impact on society.',
  ...
  },
  {
    ...
    description: 'The university invites applications for research grants aimed at supporting innovative projects and initiatives by students and faculty.',
    imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=450&fit=crop&auto=format',

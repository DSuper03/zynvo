      ...
      <div className="content-overlay relative min-h-screen">
        ...
        <section id="club-categories" className="py-20 bg-gray-950/50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                <span className="gradient-text">Discover Clubs</span> By
                Category
              </h2>
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Join thousands of students who are discovering new
                opportunities, making connections, and enhancing their college
                journey.
              </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              <div>
                ...
                <p className="mb-4">
                  Connecting college students through club and society
                  experiences.
                </p>

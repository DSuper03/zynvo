...
import { Heart, MessageCircle, Share, MoreHorizontal, ThumbsUp, Plus } from 'lucide-react';
      ...
      <div className="lg:col-span-2">
        ...
        <div className="space-y-4">
          {mockPosts.map(post => {
            ...
            return (
              <div key={post.id} className="bg-black rounded-lg overflow-hidden shadow-md border border-yellow-900/30">
                {/* Post Header */}
                <div className="p-4 flex justify-between items-center">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-yellow-500/70">{getTimeAgo(post.timestamp)}</p>
                    </div>
                  </div>
      ...
      <div className="hidden lg:block space-y-6">
        ...
        <div className="bg-black rounded-lg p-4 shadow-md border border-yellow-900/30">
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="text-xs text-yellow-500 hover:text-yellow-400">See all</button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {interestCategories.map(category => (
              ...
              >
                ...
                <span className="text-yellow-400 text-sm">{category.label}</span>
              </div>
            ))}
          </div>
        </div>

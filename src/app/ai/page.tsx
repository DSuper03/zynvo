...
export default function AIHome() {
	...
	const API_KEY = process.env.NEXT_PUBLIC_GOOGLE_AI_API_KEY as string | undefined;
	...
	const handleAsk = async (p?: string) => {
		...
		if (!hasKey) {
			setError('Missing NEXT_PUBLIC_GOOGLE_AI_API_KEY. Add it to .env.local and restart the dev server.');
			return;
		}

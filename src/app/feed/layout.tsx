    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            >
                <div className={`p-4 ${isSidebarOpen ? '' : 'hidden md:block'}`}>
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-bold text-indigo-200">Campus Connect</h2>
                        <button
                    ...
                    <div className="p-4">
                        {isSidebarOpen ? (
                            <div className="space-y-6">
                                <nav>
                                    <ul className="space-y-2">
                                        <li>
                                            <a href="/feed" className="flex items-center p-2 hover:bg-gray-700 rounded transition-colors duration-200">
                                                <span className="mr-3">🏠</span>
                                                <span>Home</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/feed/explore" className="flex items-center p-2 hover:bg-gray-700 rounded transition-colors duration-200">
                                                <span className="mr-3">🔍</span>
                                                <span>Explore</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/feed/notifications" className="flex items-center p-2 hover:bg-gray-700 rounded transition-colors duration-200">
                                                <span className="mr-3">🔔</span>
                                                <span>Notifications</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/feed/profile" className="flex items-center p-2 hover:bg-gray-700 rounded transition-colors duration-200">
                                                <span className="mr-3">👤</span>
                                                <span>Profile</span>
                                            </a>
                                        </li>
                            ...
                            <div className="flex flex-col items-center pt-4 space-y-4">
                                <a href="/feed" className="p-3 hover:bg-gray-700 rounded-full transition-colors duration-200">🏠</a>
                                <a href="/feed/explore" className="p-3 hover:bg-gray-700 rounded-full transition-colors duration-200">🔍</a>
                                <a href="/feed/notifications" className="p-3 hover:bg-gray-700 rounded-full transition-colors duration-200">🔔</a>
                                <a href="/feed/profile" className="p-3 hover:bg-gray-700 rounded-full transition-colors duration-200">👤</a>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-auto">
                <div className={`p-4 sticky top-0 z-10 bg-white shadow-sm transition-all duration-300 ${isScrolled ? 'py-2' : 'py-4'}`}>
                    <button
                        onClick={toggleSidebar}

...
import { FaClock, FaMapMarkerAlt, FaCalendarAlt, FaChevronDown, FaChevronRight } from 'react-icons/fa'
      ...
      sessions: [
        {
          ...
          description: "Check in, grab your welcome kit, enjoy breakfast and meet fellow participants.",
          location: "Main Hall",
          speakers: []
        },
        {
          ...
          description: "Welcome address, introduction to the event structure, and announcements of key information.",
        ...
        },
        {
          ...
          description: "An inspiring talk on how student innovations are shaping the future of technology and society.",
          location: "Auditorium A",
        ...
        },
        {
          ...
          description: "Enjoy lunch while forming teams and brainstorming initial ideas.",
        ...
        },
        {
          ...
          description: "Learn practical techniques to quickly validate your ideas and create functional prototypes.",
        ...
        },
        {
          ...
          description: "Teams set up their workspaces and begin developing their projects with mentor support available.",
        ...
        },
        {
          ...
          description: "Refuel with dinner and continue networking with peers and industry professionals.",
          location: "Dining Hall",
          speakers: []
        },
        {
          ...
          description: "Continue working on your projects with support from mentors. Snacks and refreshments available.",
          location: "Hacking Area",
          speakers: []
        }
      ]
      ...
      sessions: [
        {
          ...
          title: "Breakfast",
          description: "Start your day with breakfast and informal discussions.",
          location: "Dining Hall",
          speakers: []
        },
        {
          ...
          description: "Teams share their progress and challenges in a quick stand-up format.",
          location: "Main Stage",
          speakers: ["Anirban Ghosh"]
        },
        {
          ...
          description: "Learn how to design intuitive interfaces that resonate with the next generation of users.",
          location: "Design Lab",
          speakers: ["Swarnendu Ghosh"]
        },
        {
        ...
        },
        {
          ...
          description: "Practical session on how to leverage AI capabilities in your hackathon projects.",
          location: "Tech Lab C",
          speakers: ["Mohak Chakraborty"]
        },
        {
          ...
          description: "Teams continue developing their projects with ongoing mentor support.",
          location: "Hacking Area",
          speakers: []
        },
        {
          ...
          description: "Dinner served alongside quick 5-minute presentations on interesting tech topics.",
          location: "Dining Hall",
          speakers: []
        },
        {
    ...
    },
    {
      ...
      sessions: [
        ...
        },
        {
          ...
          description: "Last opportunity to finalize projects and prepare presentations.",
          location: "Hacking Area",
          speakers: []
        },
        {
          ...
          description: "Final submissions due. Lunch provided as judges begin initial review.",
          location: "Main Hall",
          speakers: []
        },
        {
          ...
          description: "Teams present their projects to judges and attendees (10 minutes per team).",
          location: "Auditorium A",
          speakers: []
        },
        {
          ...
          description: "Refreshments provided while judges make final decisions.",
        ...
        },
        {
          ...
          description: "Announcement of winners, prize distribution, and closing thoughts.",
          location: "Main Stage",
        ...
        },
        {
          ...
          description: "Celebrate the conclusion of MoodX with refreshments and networking.",
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">{eventInfo.name}</h2>
                <div className="flex flex-col sm:flex-row sm:items-center text-gray-300">
                  ...
                  <span className="sm:mx-4 hidden sm:block text-yellow-400">•</span>
            ...
            <p className="text-gray-300 border-l-4 border-yellow-400 pl-4 py-2 bg-gray-800/50 rounded-r-md">
              Join us for three days of innovation, collaboration, and inspiration. From workshops to hackathon sessions, 
              and from networking opportunities to the final presentations - immerse yourself in this transformative experience.
            </p>
          </div>
        </motion.div>
                    ...
                    >
                      <div className="flex-grow">
                        <div className="flex flex-col sm:flex-row sm:items-center mb-1">
                          <span className="font-mono text-yellow-400 text-sm">{session.time}</span>
                      ...
                      <div className={`text-gray-400 p-1 transform transition-transform ${
                    ...
                    {expandedSession === session.id && (
                      <div className="px-4 pb-4">
                        ...
                        {session.speakers.length > 0 && (
                          <div>
                            <div className="text-sm font-medium text-yellow-500 mb-2">Featuring:</div>
                            <div className="flex flex-wrap gap-2">
                              {session.speakers.map((speaker, idx) => (
                                <span key={idx} className="bg-gray-700 text-white px-3 py-1 rounded-full text-xs flex items-center">
                                  {speaker}
                                </span>
                              ))}
                            </div>
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-3">Need the schedule on the go?</h3>
          <p className="text-gray-300 mb-6">Download the complete event schedule to your calendar or as a PDF.</p>

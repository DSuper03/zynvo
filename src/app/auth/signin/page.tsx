        ...
        <div className="hidden md:block md:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gray-900">
            <div 
              ...
              style={{ 
                backgroundImage: "url('https://i.pinimg.com/736x/91/92/c9/9192c99c14e8f9d303a5ecfefd96ecc9.jpg')",
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-12">
            <div>
              ...
              <p className="text-white text-lg max-w-md opacity-90">
                Connect with students across institutions and discover exciting club opportunities.
              </p>
            </div>
              ...
              <div className="bg-black/30 backdrop-blur-md rounded-xl p-6 max-w-md">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-500 text-sm">Drama Club President, NYU</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-8 relative">
          ...
          <div className="relative z-10 w-full max-w-md">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-white mt-6 mb-2">Sign In</h1>
              <p className="text-gray-400">
                New to Zynvo? <Link href="/auth/signup" className="text-yellow-500 hover:text-yellow-400 transition">Create an account</Link>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Link href="/auth/forgot-password" className="text-sm text-yellow-500 hover:text-yellow-400 transition">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">

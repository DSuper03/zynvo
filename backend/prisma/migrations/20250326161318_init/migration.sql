...
*/
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('STUDENT', 'CLUB_ADMIN', 'MODERATOR');

-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('WORKSHOP', 'CONFERENCE', 'SOCIAL', 'ACADEMIC', 'CULTURAL');

-- CreateEnum
CREATE TYPE "PrivacyLevel" AS ENUM ('PUBLIC', 'COLLEGE_ONLY', 'PRIVATE');

const securityHeaders = [
  {
    ...
    value: `
      ...
      connect-src 'self' data: http://localhost:* https://backend.zynvo.social https://upload.imagekit.io https://zynvo-backend-ho7y.onrender.com https://zynvo-backend-1.onrender.com;
      font-src 'self' data:;
    `
      .replace(/\s{2,}/g, ' ')
      .trim(),

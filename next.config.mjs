...
const securityHeaders = [
  {
    ...
    value: `
      ...
      font-src 'self' data:;
      frame-src 'self' https://*.clerk.accounts.dev https://clerk.accounts.dev https://clerk.com https://clerk.zynvo.social https://challenges.cloudflare.com;
